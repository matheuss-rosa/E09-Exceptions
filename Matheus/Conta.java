...
public abstract class Conta implements ITaxas {
    ...
    public boolean sacar(double valor) throws SemLimiteException, ValorNegativoException {
        if (valor < 0) {
            throw new ValorNegativoException("Erro. Valor negativo para saque.");
        }
        if (valor > this.limite) {
            throw new SemLimiteException("Erro. Valor de saque excede o limite da conta.");
        }
        this.saldo -= valor;
    ...
    public boolean transferir(Conta destino, double valor) throws SemLimiteException, ValorNegativoException {
